...
export const Form: React.FC<FormProps> = props => {
    return (
        <div className="flex flex-row bg-white rounded p-2 m-2 items-center">
            <div className="basis-11/12 p-2">
                <input
                    type="text"
                    placeholder="Enter address here..."
                    className="container pl-1 pr-1 pt-2 pb-2 border-none outline-0"
                    onChange={props.onChange}
                />
            </div>
            <div className="basis-4/12">
                <button
                    className="bg-gradient-to-r from-purple-500 to-pink-500 pl-5 pr-5 pt-2 pb-2 rounded-md m-2 text-white font-bold text-sm hover:shadow-md"
                    onClick={props.onSendClick}
                >
                    <div className="flex flex-row items-center">
                        <div className="basis-10/12 mr-2 font-bold text-lg">Send me</div>
                        <div className="basis-2/12">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 x="0px" y="0px"
                                 viewBox="0 0 259.104 259.104" className="fill-white h-5">
                                <g>
                                    <g>
                                        <g>
